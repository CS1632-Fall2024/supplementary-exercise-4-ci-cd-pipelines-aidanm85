...
public class RentACatUnitTest {
	 ...
	 */
	@Test
	public void testGetCatNullNumCats0() throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
		// TODO: Fill in
		Class<?> rCatClass = r.getClass();

		Method m = rCatClass.getDeclaredMethod("getCat",int.class);
